...
@Component({
  selector: 'app-buildingwiseexpensesreport',
  templateUrl: './buildingwiseexpensesreport.component.html',
  styleUrls: ['./buildingwiseexpensesreport.component.css']
})
export class BuildingwiseexpensesreportComponent implements OnInit {
