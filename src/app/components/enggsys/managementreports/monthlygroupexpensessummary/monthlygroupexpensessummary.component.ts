...
@Component({
  selector: 'app-monthlygroupexpensessummary',
  templateUrl: './monthlygroupexpensessummary.component.html',
  styleUrls: ['./monthlygroupexpensessummary.component.css']
})
export class MonthlygroupexpensessummaryComponent implements OnInit {
