...
@Component({
  selector: 'app-lcstatusreport',
  templateUrl: './lcstatusreport.component.html',
  styleUrls: ['./lcstatusreport.component.css']
})
export class LcstatusreportComponent implements OnInit {
