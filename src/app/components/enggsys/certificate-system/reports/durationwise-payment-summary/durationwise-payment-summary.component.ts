...
@Component({
  selector: 'app-durationwise-payment-summary',
  templateUrl: './durationwise-payment-summary.component.html',
  styleUrls: ['./durationwise-payment-summary.component.css'],
})
export class DurationwisePaymentSummaryComponent implements OnInit {
  ...
  getReport(print: Boolean) {
    if (this.qf.valid) {
      ...
      let payload: any = {
        ...
        seqId: 1,
        conditionId: 1,
        name: 'Engg_RP_DurationwisePaymentSummary.rpt',
        reportParameters: {
          coy:
          ...
          recId:
            ...
            this.qf.get('recId')?.value[0] != 'ALL'
              ...
              : `'ALL'`,
          remarks:
            this.qf.get('remarks')?.value.length &&
            this.qf.get('remarks')?.value[0] != 'ALL'
              ? "${this.qf.get('remarks')?.value?"
              : `''`,
