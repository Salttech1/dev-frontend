...
@Component({
  selector: 'app-material-payments-print',
  templateUrl: './material-payments-print.component.html',
  styleUrls: ['./material-payments-print.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class MaterialPaymentsPrintComponent implements OnInit {
